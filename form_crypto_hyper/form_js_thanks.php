...
<style type="text/css">
    ...
    .formi-form-signup .formi-input-phone,
    .formi-form-signup-3-steps .formi-input-phone {
    ...
    .redirect-button.formi-btn-submit {
            ...
            <div class="formwrap-outer">
                <div class="formi-form-signup formwrap">
                    <div data-formi-form-signup-3-steps="">
                        <form name="intgrtnFormSignup3Steps" action="/form_crypto_hyper/api.php" target="_parent" class="formi-form-signup-3-steps _signup_form" method="post" autocomplete="off"
                            ...
                            <div class="formi-steps-holder">
                                <div class="formi-step formi-step-1 formi-active">
                                    <div class="formi-input-holder formi-input-holder-first-name">
                                        ...
                                        <input class="formi-input" type="text" name="fio" style="<?= $language == 'ar' ? 'text-align: right; direction: rtl' : '' ?>"
                                            placeholder="<?= $translate[$language]['Nombre']; ?>" value="" required="" autocomplete="off">
                                    ...
                                    <div class="formi-input-holder formi-input-holder-first-name">
                                        ...
                                        <input class="formi-input" type="text" name="lastName" style="<?= $language == 'ar' ? 'text-align: right; direction: rtl' : '' ?>"
                                            placeholder="<?= $translate[$language]['Apellido']; ?>" value="" required="" autocomplete="off">
                                ...
                                <div class="formi-step formi-step-2 formi-active">
                                    <div class="formi-input-holder formi-input-holder-first-name">
                                        ...
                                        <input class="formi-input" type="text" name="solrka" style="<?= $language == 'ar' ? 'text-align: right; direction: rtl' : '' ?>"
                                            pattern="^(?!example@email\.com$).+@.+\.[A-Za-z]{2,}$" title="example@email.com" placeholder="<?= $translate[$language]['Email']; ?>" value="" required=""
                                            autocomplete="off">
                                    ...
                                    <div class="formi-input-holder formi-input-holder-phone formi-invalid">
                                        ...
                                        <div class="formi-input-group" style="display: grid; direction: ltr;text-align: left;">
                                            <input class="formi-input formi-input-area-code formi-input-area-code-flags" type="text" name="areaCode" placeholder="Area Code" value="" dir="ltr"
                                                data-country-code="">
                                            <input class="formi-input formi-input-phone formi-invalid txt-phone" type="text" name="search2" role="presentation" style="text-align: left;"
                                                autocomplete="off" dir="ltr" size="1" placeholder="<?= $translate[$language]['Teléfono']; ?>" value="" required="">
                                        </div>
                                ...
                                <div class="formi-step formi-step-3  formi-active">
                                    <div class="formi-btn-submit-holder">
                                        <button class="formi-btn-submit submit-btn" style="<?= $color; ?>" type="submit"><?= ($submit == '') ? $translate[$language]['REGISTRO'] : $submit; ?></button>
                                    </div>
                                </div>
                    ...
                    <div style="display: none" class="country-asking">
                        <div class="wait-block">
                            <p style="display: none" class="preparing-data"><?= $translate[$language]['Preparing data']; ?></p>
                            <p style="display: none" class="preparing-register"><?= $translate[$language]['Registering in system']; ?></p>
